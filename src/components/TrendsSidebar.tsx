...
const TrendsSidebar = () => {
  return (
    <div className="sticky top-[5.25rem] h-fit w-72 flex-none space-y-5 sm:hidden md:block lg:w-80">
        ...
        <div key={user.id} className="flex items-center justify-between gap-3">
          ...
          >
            ...
            <div>
                ...
                <p className="line-clamp-1 text-muted-foreground break-all">@{user.username}</p>
            </div>
          </Link>
